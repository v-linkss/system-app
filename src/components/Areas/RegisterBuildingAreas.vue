...
export default {
  ...
  methods: {
    ...
    async filterTipos(searchText) {
      try {
        const response = await axios.get(process.env.VUE_APP_API_ACESS,"/PrediosAreas");
    ...
    async loadTipos() {
      try {
        const response = await axios.get(process.env.VUE_APP_API_ACESS,"/TabValores");
    ...
    async submit() {
      ...
      try {
        const response = await axios.post(
          process.env.VUE_APP_API_ACESS,"/PrediosAmbiente",
          data
        );
